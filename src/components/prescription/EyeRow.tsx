    ...
    <div className="grid grid-cols-[80px_repeat(4,1fr)] gap-2">
      ...
      <div>
        <input
          ...
          className={`input-text ${fieldErrors[`${side}_sphere`] ? errorInputClass : normalInputClass} ${isView ? "bg-gray-200" : ""}`}
          placeholder="-00.00"
          min="-60"
          max="60"
          step="0.25"
      ...
      <div>
        <input
          ...
          className={`input-text ${fieldErrors[`${side}_cylinder`] ? errorInputClass : normalInputClass} ${isView ? "bg-gray-200" : ""}`}
          placeholder="-00.00"
          min="-15"
          max="15"
          step="0.25"
      ...
      <div>
        <input
          ...
          className={`input-text ${fieldErrors[`${side}_axis`] ? errorInputClass : normalInputClass} ${isView ? "bg-gray-200" : ""}`}
          placeholder="000"
          min="1"
          max="180"
          step="1"
      ...
      <div>
        <input
          ...
          className={`input-text ${fieldErrors[`${side}_reading_add`] ? errorInputClass : normalInputClass} ${isView ? "bg-gray-200" : ""}`}
          placeholder="+00.00"
          min="0.25"
          max="4"
          step="0.25"
