    ...
    <div className="grid grid-cols-[25px_repeat(4,1fr)] md:grid-cols-5 gap-2">
      ...
      <div>
        <input
          ...
          className={`input-text ${fieldErrors[`${side}_pupillary_distance`] ? errorInputClass : normalInputClass} ${isView ? "bg-gray-200" : ""}`}
          placeholder="00"
          min="19"
          max="85"
          step="0.25"
      ...
      <div>
        <input
          ...
          className={`input-text ${fieldErrors[`sigmant_${side}`] ? errorInputClass : normalInputClass} ${isView ? "bg-gray-200" : ""}`}
          placeholder="00"
          min={7}
          max={55}
          step={1}
      ...
      <div>
          ...
          className={`input-text ${fieldErrors[`vertical_distance_${side}`] ? errorInputClass : normalInputClass} ${isView ? "bg-gray-200" : ""}`}
          placeholder="00"
          disabled={isView}
          min={10}
          max={15}
      ...
      <div>
        <input
          type="text"
          {...register(`a_v_${side}`)}
          className={`input-text ${fieldErrors[`a_v_${side}`] ? errorInputClass : normalInputClass} ${isView ? "bg-gray-200" : ""}`}
          placeholder="V/A"
          disabled={isView}
          title="Vision acuity"
        />
